...
function Dashboard() {
    ...
    return (
        <div className={"grid grid-cols-5 grid-rows-7 gap-2 h-screen w-screen bg-gray-300"}>
            ...
            <div className={"row-span-6 col-start-1 row-start-2 flex-wrap justify-center h-full" +
                " w-full bg-gray-200"}>
